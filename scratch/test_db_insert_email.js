...
async function test() {
  console.log("Attempting insert with created_by email...");
  const payload = {
    title: "Test Job With Email " + Date.now(),
    slug: "test-job-email-" + Date.now(),
    ...
    created_by: "akshatansh02@gmail.com" // <-- User's exact email from dashboard
  };
