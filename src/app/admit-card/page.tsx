...
export const metadata: Metadata = {
  title: "Admit Card Download 2026 | SSC, Railway, Bank Hall Tickets",
  description: "Download latest Admit Card 2026, Hall Tickets & Call Letters for SSC, Railway RRB, Banking IBPS/SBI, UPSC, Police & State Services. Direct download links on Rojgar Suvidha.",
  keywords: [
    "admit card 2026", "admit card download",
    "hall ticket download", "call letter 2026",
    "ssc admit card 2026", "ssc cgl admit card",
  ...
  openGraph: {
    title: "Admit Card Download 2026 | Hall Tickets & Call Letters",
    description: "Fastest direct download links for Admit Cards 2026. SSC, Railway, Banking, UPSC, Police & State Exams.",
    url: `${BASE_URL}/admit-card`,
    type: "website",
    siteName: "Rojgar Suvidha",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Admit Card Download 2026" }],
  },
};
...
export default function AdmitCardPage() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Admit Card", item: `${BASE_URL}/admit-card` },
    ],
  };
