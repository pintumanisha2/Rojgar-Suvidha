...
export const metadata: Metadata = {
  title: "Exam Calendar 2026 | Govt Exam Schedule, Last Dates & Notifications",
  description:
    "Complete Government Exam Calendar 2026. Track upcoming SSC, UPSC, Railway, Banking, Police & Defence exam dates, last dates to apply, admit card dates & result dates. Never miss a sarkari exam deadline again.",
  keywords: [
    "exam calendar 2026", "govt exam schedule 2026",
    "upcoming government exams 2026", "sarkari exam dates 2026",
    "SSC CGL 2026 exam date", "RRB NTPC exam date 2026",
    "IBPS PO 2026 exam schedule", "UPSC CSE 2026 schedule",
    "government exam last date 2026", "sarkari naukri exam timetable",
    "bank exam calendar 2026", "railway exam dates 2026",
    "upcoming sarkari exam 2026", "exam notification calendar",
    "rojgar suvidha exam calendar",
  ],
  alternates: { canonical: `${BASE_URL}/exam-calendar` },
  openGraph: {
    title: "Govt Exam Calendar 2026 | Upcoming Exam Dates | Rojgar Suvidha",
    description:
    ...
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Government Exam Calendar 2026" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Govt Exam Calendar 2026 | Rojgar Suvidha",
...
const upcomingExams = [
  {
    name: "SSC CGL 2026 Tier 1 Exam",
    description: "Staff Selection Commission Combined Graduate Level Tier 1 Examination 2026. Vacancies for Group B & C posts across various ministries.",
  ...
  {
    name: "RRB NTPC 2026 Exam",
    description: "Railway Recruitment Board Non-Technical Popular Category (NTPC) Graduate Level Posts 2026.",
  ...
  {
    name: "IBPS PO 2026 Exam",
    description: "Institute of Banking Personnel Selection Probationary Officer CRP PO/MT XVI 2026 Exam.",
    startDate: "2026-10-11",
    endDate: "2026-10-12",
    lastDateApply: "2026-09-05",
