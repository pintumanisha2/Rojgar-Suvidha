...
export const metadata: Metadata = {
  title: "Sarkari Result 2026 | Check Government Exam Results Online",
  description: "Check latest Sarkari Results 2026 online. SSC Result, Railway Result, Bank Exam Result, UPSC Result, Police Result & State Level Exam Merit Lists on Rojgar Suvidha. Fastest result updates.",
  keywords: [
    "sarkari result", "sarkari result 2026",
    "government exam results", "govt exam result online",
    "ssc result 2026", "ssc cgl result", "ssc chsl result",
    "railway result 2026", "rrb ntpc result", "rrb group d result",
    "bank exam result", "ibps result", "sbi result",
    "upsc result", "up police result", "bihar police result",
    "merit list 2026", "cut off marks 2026",
  ...
  openGraph: {
    ...
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Sarkari Result 2026" }],
  },
};
...
export default function ResultsPage() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Results", item: `${BASE_URL}/results` },
    ],
  };
    ...
    <article className="space-y-6">
      ...
      <div className="overflow-x-auto mt-4">
        <table className="w-full text-left border-collapse border border-gray-200 dark:border-gray-700">
          ...
          <tbody>
            <tr>
              <td className="p-3 border border-gray-200 dark:border-gray-700 font-semibold">SSC Results</td>
              <td className="p-3 border border-gray-200 dark:border-gray-700">SSC CGL, CHSL, MTS, GD Constable, CPO, Steno</td>
            </tr>
            <tr>
              <td className="p-3 border border-gray-200 dark:border-gray-700 font-semibold">Railway Results</td>
              <td className="p-3 border border-gray-200 dark:border-gray-700">RRB NTPC, Group D, ALP, Technicians, RPF</td>
            </tr>
            <tr>
              <td className="p-3 border border-gray-200 dark:border-gray-700 font-semibold">Banking Results</td>
              <td className="p-3 border border-gray-200 dark:border-gray-700">IBPS PO, Clerk, RRB, SBI PO, Clerk, RBI Grade B</td>
            </tr>
            <tr>
              <td className="p-3 border border-gray-200 dark:border-gray-700 font-semibold">UPSC & State PSC</td>
              <td className="p-3 border border-gray-200 dark:border-gray-700">UPSC Civil Services, NDA, CDS, UPPSC, BPSC, MPPSC</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="bg-green-50 dark:bg-green-950/30 border-l-4 border-green-500 p-4 rounded-r-lg mt-8">
        <h4 className="font-bold text-green-900 dark:text-green-300 flex items-center gap-2">
          Step-by-step Guide After Result Declaration
        </h4>
      ...
      <p className="text-gray-700 dark:text-gray-300 mt-8 pb-4 border-b border-gray-200 dark:border-gray-800">
        Bookmark this page to stay ahead of the curve. Rojgar Suvidha is committed to providing the fastest updates for <strong>Sarkari Results 2026</strong>. We wish you the very best of luck in your career journey!
      </p>
    </article>
  );
